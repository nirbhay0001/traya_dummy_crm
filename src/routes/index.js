...
import AllTickets from "components/my_tickets/all_tickets/AllTickets";
import AssignedTickets from "components/my_tickets/assigned_tickets/AssignedTickets";
import Stats from "components/my_tickets/stats/Stats";
...
import Cr from "components/app/events/create-an-event/CreateEvent";
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        <Route path="dashboard/engagementV2" element={<EngagementV2 />} />
        <Route path="dashboard/engagement" element={<Engagement />} />
        <Route path="ivrCall" element={<IvrCall />} />
        ...
        {/* routes of myTicket */}
        <Route path="events/create-an-event" element={<EventDetail />} />
        <Route path="myTickets/AssignedTickets" element={<AssignedTickets />} />
        <Route path="myTickets/AllTickets" element={<AllTickets />} />
        <Route path="myTickets/stats" element={<Stats />} />
        <Route path="events/event-detail " element={<CreateEvent />} />
